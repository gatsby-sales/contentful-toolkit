        ...
        >
          ...
          >
            {navItems.map((navItem) => {
              navItem = navItem.description
                ? { ...navItem, ...navItem.link }
                : navItem // Pull nested link info out of LinkWDescription type
              return (
                <li key={navItem.id}>
                    ...
                    <Flex variant="start" gap={3}>
                      {navItem.icon && (
                        <GatsbyImage
                          ...
                          image={getImage(navItem.icon.image.gatsbyImageData)}
